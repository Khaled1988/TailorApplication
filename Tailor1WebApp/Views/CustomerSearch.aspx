            ...
            <asp:ListView ID="lvAllBrandList" runat="server" DataKeyNames="CustomerID" OnItemCommand="lvAllBrandList_ItemCommand"
                ...
                <LayoutTemplate>
                    <table class="table table-bordered table-responsive">
                        <tr id="trHead" runat="server">
                            ...
                            <th id="th2" runat="server" align="center">Customer ID
                            </th>
                            <th id="th4" runat="server" align="center">Department
                            </th>
                            <th id="th5" runat="server" align="center">Customer Type
                            </th>
                ...
                <ItemTemplate>
                    <tr id="trBody" runat="server" class="dGridRowClass">
                        ...
                        <td align="left">
                            <%--<asp:LinkButton ID="lnkbtnName" runat="server" CausesValidation="false"></asp:LinkButton>--%>
                        ...
                        <td align="left">
                            <asp:Label ID="lblCustomerType" runat="server" ForeColor="Black"></asp:Label>
                        </td>
                        <td align="left">
